...
class AIService
{
    ...
    public function generateContent(string $description): string
    {
        $prompt = "Tạo nội dung về chủ đề: {$description}";
    ...
    public function generateStrategyFromInsights(array $insights, string $description = ''): string
    {
    ...
    public function postToFacebookWithImage(string $pageId, string $message, string $localImagePath)
    {
